...
const NotifComponent = () => {
  ...
  return (
    <div className="left-0 fixed w-full py-12 sm:py-0 sm:absolute sm:left-custom top-0 h-screen sm:w-80 rounded-r-lg border-r-px1 border-r-gray-200 flex flex-col gap-3 z-0 sm:z-30 bg-white">
